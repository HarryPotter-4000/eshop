...
const PRODUCTS = [
	...
	},
	{
		id: 4,
		name: 'Sphere',
		description: ' It is one of many cores that was attached to GLaDOS in order to regulate her behavior.',
		price: 80,
        image: wheatley,
        // other fields
	},
    {
		id: 5,
		name: 'Turret',
		description: 'Tripod robots that appear in every game in the Portal series.',
        price: 50,
        image: turret,
		// other fields
	},
